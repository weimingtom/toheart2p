...
BOOL DRW_DrawBMP_FTT( DRAW_OBJECT dobj, int interless )
{
	...
	if( dest->buf==NULL ) { DebugPrintf("Ãè»­îIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FTT]\n"); return FALSE; }
	if( src1->buf==NULL ) { DebugPrintf("»­ÏñîIÓò1¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FTT]\n"); return FALSE; }
	if( src2->buf==NULL ) { DebugPrintf("»­ÏñîIÓò2¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FTT]\n"); return FALSE; }
...
BOOL DRW_DrawBMP_FFBM( DRAW_OBJECT dobj, int interless )
{
	...
	if( dest->buf==NULL ) { DebugPrintf( "Ãè»­îIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FFBM]\n" ); return FALSE; }
	if( src1->buf==NULL ) { DebugPrintf( "»­ÏñîIÓò1¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FFBM]\n" ); return FALSE; }
	if( src2->buf==NULL ) { DebugPrintf( "»­ÏñîIÓò2¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FFBM]\n" ); return FALSE; }
	if( mask->buf==NULL ) { DebugPrintf( "¥Þ¥¹¥¯îIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FFBM]\n" ); return FALSE; }
...
BOOL DRW_DrawBMP_FT( DRAW_OBJECT dobj, int interless )
{
	...
	if( dest->buf==NULL ) 
	{	
		DebugPrintf("Ãè»­îIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FT]\n");
		return FALSE;
	}
	if( src->buf==NULL  )
	{
		DebugPrintf("»­ÏñîIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FT]\n"); 
		return FALSE;
	}
...
BOOL DRW_DrawBMP_FF( DRAW_OBJECT dobj, int interless )
{
	...
	if( dest->buf==NULL ) {	DebugPrintf("Ãè»­îIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FF]\n"); return FALSE; }
	if( src->buf==NULL  ) { DebugPrintf("»­ÏñîIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FF]\n"); return FALSE; }
...
BOOL DRW_DrawBMP_FB( DRAW_OBJECT dobj, int interless )
{
	...
	if( dest->buf==NULL ) { DebugPrintf("Ãè»­îIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FB]\n"); return FALSE; }
	if( src->buf==NULL  ) {	DebugPrintf("»­ÏñîIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawBMP_FB]\n"); return FALSE; }
...
BOOL DRW_DrawZOOM_FT( DRAW_OBJECT dobj, int interless )
{
	...
	if( dest->buf==NULL ) { DebugPrintf("Ãè»­îIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawZOOM_FT]\n"); return FALSE; }
	if( src->buf==NULL  ) {	DebugPrintf("»­ÏñîIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawZOOM_FT]\n"); return FALSE; }
...
BOOL DRW_DrawZOOM_FF( DRAW_OBJECT dobj, int interless )
{
	...
	if( dest->buf==NULL ) { DebugPrintf("Ãè»­îIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawZOOM_FF]\n"); return FALSE; }
	if( src->buf==NULL  ) {	DebugPrintf("»­ÏñîIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawZOOM_FF]\n"); return FALSE; }
...
BOOL DRW_DrawZOOM_FB( DRAW_OBJECT dobj, int interless )
{
	...
	if( dest->buf==NULL ) { DebugPrintf("Ãè»­îIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawZOOM_FB]\n"); return FALSE; }
	if( src->buf==NULL  ) {	DebugPrintf("»­ÏñîIÓò¤¬¤¢¤ê¤Þ¤»¤ó[DRW_DrawZOOM_FB]\n"); return FALSE; }
...
BOOL DRW_DrawPOLY4_FF( DRAW_OBJECT dobj, int interless )
{
	...
	if( dest->buf==NULL ) { DebugPrintf("Ãè»­îIÓò¤¬¤¢¤ê¤Þ¤»¤ó\n"); ret=FALSE; goto end; }
	if( src->buf==NULL  ) { DebugPrintf("»­ÏñîIÓò¤¬¤¢¤ê¤Þ¤»¤ó\n"); ret=FALSE; goto end; }
