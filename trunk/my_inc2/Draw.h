...
enum
{
	DRW_NML = 0x00, DRW_ADD, DRW_OOI, DRW_SUB, DRW_DIM, DRW_MUL, DRW_OLY, DRW_CML, DRW_CMD, DRW_NEG, DRW_TNC, 

	DRW_BLD2, DRW_VIV2, DRW_AMI2, DRW_NIS2, DRW_MOZ2, DRW_BOM2, 
	...
	DRW_SUI2, DRW_SBL2, DRW_WAV2, DRW_WBL2, DRW_LST2, DRW_LBL2, 

	DRW_WAP2, 

	DRW_LCF2, DRW_LPP2 = DRW_LCF2 + 6, DRW_DIA2 = DRW_LPP2 + 6, DRW_DIO2 = DRW_DIA2 + 3, 
...
extern BOOL ClipRect(int *dest_px, int *dest_py, int dest_sx, int dest_sy, int *src_px, int *src_py, int src_sx, int
src_sy, int *w, int *h, RECT *clip);

extern BOOL ClipRectS2(int *dest_px, int *dest_py, int dest_sx, int dest_sy, int *src1_px, int *src1_py, int src1_sx,
int src1_sy, int *w1, int *h1, int *src2_px, int *src2_py, int src2_sx, int src2_sy, int *w2, int *h2, RECT *clip);

extern BOOL ClipRectZ(int *sx, int *sy, int *sw, int *sh, int *dx, int *dy, int *dw, int *dh, int *xx, int *yy, int
dest_sx, int dest_sy, int src_sx, int src_sy, RECT *clip);
...
extern BOOL ClipRectLineRGB(int *x1, int *y1, int *r1, int *g1, int *b1, int *x2, int *y2, int *r2, int *g2, int *b2,
...
extern void DrawMinMaxTableRGB(int x1, int y1, int r1, int g1, int b1, int x2, int y2, int r2, int g2, int b2, RECT
*clip, MIN_MAX mi[], MIN_MAX ma[]);
extern void DrawMinMaxTableSrc(int x1, int y1, int sx1, int sy1, int x2, int y2, int sx2, int sy2, RECT *clip, MIN_MAX
mi[], MIN_MAX ma[]);
...
extern DRAW_OBJECT DRW_SetDrawObjectLocal(int bppd, void *dest, int dx, int dy, int dw, int dh, int bpps1, void *src1,
int sx1, int sy1, int sw1, int sh1, int r, int g, int b, int nuki, RECT *clip, int param1, int rparam);

extern DRAW_OBJECT DRW_SetDrawObject(int bppd, void *dest, int dx, int dy, int dw, int dh, int bpps1, void *src1, int
sx1, int sy1, int sw1, int sh1, int bpps2, void *src2, int sx2, int sy2, int sw2, int sh2, int r, int g, int b, int
nuki, RECT *clip, int param1, int param2, int param3, int rparam);

extern void DRW_SetDrawObjectPoly(DRAW_OBJECT *dobj, int dx, int dy, int dx2, int dy2, int dx3, int dy3, int dx4, int
dy4, int sx1, int sy1, int sx12, int sy12, int sx13, int sy13, int sx14, int sy14);
...
extern void DRW_SetDrawObject2XXX(DRAW_OBJECT *dobj, DRAW_OBJECT *dobj2, DRAW_OBJECT *dobj3, DRAW_OBJECT *dobj4,
DRAW_OBJECT *dobj5);
...
extern BOOL DRW_DrawBMP_BB(BMP_BT *dest, int dest_x, int dest_y, BMP_BT *src, int src_x, int src_y, int w, int h, int
nuki, RECT *clip, int r, int g, int b, DWORD wparam, DWORD rparam);
