...
BOOL PRM_DrawRect_F_Std(BMP_F *dest, int dx, int dy, int w, int h, int r, int g, int b)
{
	int y;
...
BOOL PRM_DrawRect_F_Bld(BMP_F *dest, int dx, int dy, int w, int h, int r, int g, int b, int blnd)
{
	int x, y;
	RGB24 *dest_p = dest->buf + dy * dest->sx + dx;
	int drev = dest->sx - w;
	...
	char rgb_tbl[24] = 
	{
		bb, gg, rr, bb, gg, rr, bb, gg, rr, bb, gg, rr, bb, gg, rr, bb, gg, rr, bb, gg, rr, bb, gg, rr
	};
...
BOOL PRM_DrawRect_F_Add(BMP_F *dest, int dx, int dy, int w, int h, int r, int g, int b)
{
	int x, y;
	RGB24 *dest_p = dest->buf + dy * dest->sx + dx;
	int drev = dest->sx - w;
...
BOOL PRM_DrawRect_F_Sub(BMP_F *dest, int dx, int dy, int w, int h, int r, int g, int b)
{
	int x, y;
	RGB24 *dest_p = dest->buf + dy * dest->sx + dx;
	int drev = dest->sx - w;
...
BOOL PRM_DrawRect_F_Mul(BMP_F *dest, int dx, int dy, int w, int h, int r, int g, int b)
{
	int x, y;
	RGB24 *dest_p = dest->buf + dy * dest->sx + dx;
	int drev = dest->sx - w;
...
BOOL PRM_DrawRect_F_Ami(BMP_F *dest, int dx, int dy, int w, int h, int r, int g, int b, int mesh)
{
	int x, y;
	RGB24 *dest_p = dest->buf + dy * dest->sx + dx;
	int drev = dest->sx - w;
...
BOOL PRM_DrawRect_F_Nis(BMP_F *dest, int dx, int dy, int w, int h, int r, int g, int b, int noise)
{
	int x, y;
	RGB24 *dest_p = dest->buf + dy * dest->sx + dx;
	int drev = dest->sx - w;
...
BOOL PRM_DrawRipple_F(BMP_F *dest, int dx, int dy, RECT *clip, int r, int g, int b, DWORD wparam)
{
	BOOL ret = TRUE;
	...
	if (dest->buf == NULL)
	{
		DebugPrintf("√Ëª≠ÓI”Ú§¨§¢§Í§ﬁ§ª§Û[PRM_DrawRect_F]\n");
		return FALSE;
	}
...
BOOL PRM_DrawRect_F(BMP_F *dest, int dx, int dy, int w, int h, RECT *clip, int r, int g, int b, DWORD wparam)
{
	BOOL ret = TRUE;
	int blnd = HIWORD(wparam);
	int param = LOWORD(wparam);
...
BOOL PRM_DrawF3_F(BMP_F *dest, int x1, int y1, int x2, int y2, int x3, int y3, RECT *clip, int r, int g, int b, DWORD wparam)
{
	BOOL ret = TRUE;
	int blnd = HIWORD(wparam);
	int param = LOWORD(wparam);
...
BOOL PRM_DrawF4_F(BMP_F *dest, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, RECT *clip, int r, int g, int b, DWORD wparam)
{
	BOOL ret = TRUE;
	int blnd = HIWORD(wparam);
	int param = LOWORD(wparam);
...
BOOL PRM_DrawY3_F(BMP_F *dest, int x1, int y1, int x2, int y2, int x3, int y3, RECT *clip, int sy, int sr, int sg, int sb, int ey, int er, int eg, int eb,
				  DWORD wparam)
{
	BOOL ret = TRUE;
	int blnd = HIWORD(wparam);
...
BOOL PRM_DrawY4_F(BMP_F *dest, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, RECT *clip, int sy, int sr, int sg, int sb, int ey, int er, int
				  eg, int eb, DWORD wparam)
{
	BOOL ret = TRUE;
	int blnd = HIWORD(wparam);
	int param = LOWORD(wparam);
...
BOOL PRM_DrawGxLine_F_Std(char *dest_p, MIN_MAX *mi, MIN_MAX *ma, int r, int g, int b, int pr, int pg, int pb, int dr, int dg, int db, int fr, int fg, int fb,
						  int w, int ww)
{
	int rr = 0, gg = 0, bb = 0;
	int x;
...
BOOL PRM_DrawGxLine_F_Bld(char *dest_p, MIN_MAX *mi, MIN_MAX *ma, int r, int g, int b, int pr, int pg, int pb, int dr, int dg, int db, int fr, int fg, int fb,
						  int w, int ww, int blnd)
{
	int brev = 256-blnd;
	int rr = 0, gg = 0, bb = 0;
	int x;
...
BOOL PRM_DrawGxLine_F_Add(char *dest_p, MIN_MAX *mi, MIN_MAX *ma, int r, int g, int b, int pr, int pg, int pb, int dr, int dg, int db, int fr, int fg, int fb,
						  int w, int ww)
{
	int rr = 0, gg = 0, bb = 0;
	int x;
...
BOOL PRM_DrawGxLine_F_Sub(char *dest_p, MIN_MAX *mi, MIN_MAX *ma, int r, int g, int b, int pr, int pg, int pb, int dr, int dg, int db, int fr, int fg, int fb,
						  int w, int ww)
{
	int rr = 0, gg = 0, bb = 0;
	int x;
...
BOOL PRM_DrawGxLine_F_Mul(char *dest_p, MIN_MAX *mi, MIN_MAX *ma, int r, int g, int b, int pr, int pg, int pb, int dr, int dg, int db, int fr, int fg, int fb,
						  int w, int ww)
{
	int rr = 0, gg = 0, bb = 0;
	int x;
...
BOOL PRM_DrawGxLine_F_Ola(char *dest_p, MIN_MAX *mi, MIN_MAX *ma, int r, int g, int b, int pr, int pg, int pb, int dr, int dg, int db, int fr, int fg, int fb,
						  int w, int ww)
{
	int rr = 0, gg = 0, bb = 0;
	int x;
...
BOOL PRM_DrawGxLine_F(char *dest_p, MIN_MAX *mi, MIN_MAX *ma, RECT *clip, DWORD wparam)
{
	...
	default:
	case DRW_NML:
		ret = PRM_DrawGxLine_F_Std(dest_p, mi, ma, r *xx / ww + mi->rgb.r, g *xx / ww + mi->rgb.g, b *xx / ww + mi->rgb.b, r / ww, g / ww, b / ww, dr, dg, db, fr,
			fg, fb, w, ww);
		break;
	case DRW_BLD2:
		ret = PRM_DrawGxLine_F_Bld(dest_p, mi, ma, r *xx / ww + mi->rgb.r, g *xx / ww + mi->rgb.g, b *xx / ww + mi->rgb.b, r / ww, g / ww, b / ww, dr, dg, db, fr,
			fg, fb, w, ww, blnd);
		break;
	case DRW_ADD:
		ret = PRM_DrawGxLine_F_Add(dest_p, mi, ma, r *xx / ww + mi->rgb.r, g *xx / ww + mi->rgb.g, b *xx / ww + mi->rgb.b, r / ww, g / ww, b / ww, dr, dg, db, fr,
			fg, fb, w, ww);
		break;
	case DRW_SUB:
		ret = PRM_DrawGxLine_F_Sub(dest_p, mi, ma, r *xx / ww + mi->rgb.r, g *xx / ww + mi->rgb.g, b *xx / ww + mi->rgb.b, r / ww, g / ww, b / ww, dr, dg, db, fr,
			fg, fb, w, ww);
		break;
	case DRW_MUL:
		ret = PRM_DrawGxLine_F_Mul(dest_p, mi, ma, r *xx / ww + mi->rgb.r, g *xx / ww + mi->rgb.g, b *xx / ww + mi->rgb.b, r / ww, g / ww, b / ww, dr, dg, db, fr,
			fg, fb, w, ww);
		break;
	case DRW_AMI2:
		break;
...
BOOL PRM_DrawG3_F(BMP_F *dest, int x1, int y1, int r1, int g1, int b1, int x2, int y2, int r2, int g2, int b2, int x3, int y3, int r3, int g3, int b3, RECT
				  *clip, DWORD wparam)
{
	BOOL ret = TRUE;
	int blnd = HIWORD(wparam);
...
BOOL PRM_DrawG4_F(BMP_F *dest, int x1, int y1, int r1, int g1, int b1, int x2, int y2, int r2, int g2, int b2, int x3, int y3, int r3, int g3, int b3, int x4,
				  int y4, int r4, int g4, int b4, RECT *clip, DWORD wparam)
{
	BOOL ret = TRUE;
	int blnd = HIWORD(wparam);
	int param = LOWORD(wparam);
...
BOOL PRM_DrawFLine_F_Std(BMP_F *dest, int x1, int y1, int x2, int y2, int r, int g, int b)
{
	RGB32 rgb = 
	{
		b, g, r, 0
...
BOOL PRM_DrawFLine_F_Bld(BMP_F *dest, int x1, int y1, int x2, int y2, int r, int g, int b, int blnd)
{
	char *dest_p = (char*)(dest->buf + y1 * dest->sx + x1);
	int x, y;
	int w = x2 - x1, wcnt = 0;
...
BOOL PRM_DrawFLine_F_Add(BMP_F *dest, int x1, int y1, int x2, int y2, int r, int g, int b)
{
	char *dest_p = (char*)(dest->buf + y1 * dest->sx + x1);
	int x, y;
	int w = x2 - x1, wcnt = 0;
...
BOOL PRM_DrawFLine_F_Sub(BMP_F *dest, int x1, int y1, int x2, int y2, int r, int g, int b)
{
	char *dest_p = (char*)(dest->buf + y1 * dest->sx + x1);
	int x, y;
	int w = x2 - x1, wcnt = 0;
...
BOOL PRM_DrawFLine_F_Mul(BMP_F *dest, int x1, int y1, int x2, int y2, int r, int g, int b)
{
	char *dest_p = (char*)(dest->buf + y1 * dest->sx + x1);
	int x, y;
	int w = x2 - x1, wcnt = 0;
...
BOOL PRM_DrawFLine_F(BMP_F *dest, int x1, int y1, int x2, int y2, RECT *clip, int r, int g, int b, DWORD wparam)
{
	BOOL ret = TRUE;
	int blnd = HIWORD(wparam);
	int param = LOWORD(wparam);
	...
	if (dest->buf == NULL)
	{
		DebugPrintf("√Ëª≠ÓI”Ú§¨§¢§Í§ﬁ§ª§Û[PRM_DrawFLine_F]\n");
		return FALSE;
	}
...
BOOL PRM_DrawGLine_F_Std(BMP_F *dest, int x1, int y1, int r1, int g1, int b1, int x2, int y2, int r2, int g2, int b2)
{
	int x, y;
	char *dest_p = (char*)(dest->buf + y1 * dest->sx + x1);
	RGB32 rgb = 
...
BOOL PRM_DrawGLine_F_Bld(BMP_F *dest, int x1, int y1, int r1, int g1, int b1, int x2, int y2, int r2, int g2, int b2, int blnd)
{
	int x, y;
	char *dest_p = (char*)(dest->buf + y1 * dest->sx + x1);
	RGB32 rgb = 
...
BOOL PRM_DrawGLine_F_Add(BMP_F *dest, int x1, int y1, int r1, int g1, int b1, int x2, int y2, int r2, int g2, int b2)
{
	int x, y;
	char *dest_p = (char*)(dest->buf + y1 * dest->sx + x1);
	RGB32 rgb = 
...
BOOL PRM_DrawGLine_F_Sub(BMP_F *dest, int x1, int y1, int r1, int g1, int b1, int x2, int y2, int r2, int g2, int b2)
{
	int x, y;
	char *dest_p = (char*)(dest->buf + y1 * dest->sx + x1);
	RGB32 rgb = 
...
BOOL PRM_DrawGLine_F_Mul(BMP_F *dest, int x1, int y1, int r1, int g1, int b1, int x2, int y2, int r2, int g2, int b2)
{
	int x, y;
	char *dest_p = (char*)(dest->buf + y1 * dest->sx + x1);
	RGB32 rgb = 
...
BOOL PRM_DrawGLine_F(BMP_F *dest, int x1, int y1, int r1, int g1, int b1, int x2, int y2, int r2, int g2, int b2, RECT *clip, DWORD wparam)
{
	BOOL ret = TRUE;
	int blnd = HIWORD(wparam);
	int param = LOWORD(wparam);
	...
	if (dest->buf == NULL)
	{
		DebugPrintf("√Ëª≠ÓI”Ú§¨§¢§Í§ﬁ§ª§Û[PRM_DrawGLine_F]\n");
		return FALSE;
	}
...
BOOL PRM_DrawHanabi_F(BMP_F *dest, int cx, int cy, int rate, RECT *clip)
{
	...
	if (dest->buf == NULL)
	{
		DebugPrintf("√Ëª≠ÓI”Ú§¨§¢§Í§ﬁ§ª§Û[PRM_DrawHanabi_F]\n");
		return FALSE;
	}
	if (rate == 0)
	{
