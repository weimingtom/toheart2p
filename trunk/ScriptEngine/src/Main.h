...
#define TITLE_NAME		"ToHeart2 XRATED¡«³¯±ÈÄÎ¤ß¤¯¤ëÐÞ¶©°æ¡«"
...
enum
{
	MAIN_INIT = 0, MAIN_GAME, MAIN_TERM, 
};

enum
{
	GAME_DEMO = 0, GAME_TITLE, GAME_OPENNING, GAME_AVG, GAME_ENDING, GAME_OMAKE, 
};
