	...
	extern BOOL FNT_DrawChar(void *dest, int draw_mode, int dest_x, int dest_y, int moji, int fsize, RECT *clip, int r, int
	g, int b, int alph, int kage, int han);
	extern void FNT_DrawText(void *dest, int draw_mode, int dest_x, int dest_y, int pich_w, int pich_h, char *str, int
	fsize, RECT *clip, int r, int g, int b, int alph, int kage);
